...
export const FRONT_PLANTS = [
  { id:'magnolia', name:'Magnolia', subtitle:'Back of garden', species:"Magnolia x soulangeana",
    type:'magnolia', pos:{x:0.82, y:0.13}, health:'resting', color:'#e8a0c0', moveable:false,
  ...
  { id:'dko-1', name:"Double Knock Out Rose", subtitle:'Left column, top', species:"Rosa 'Double Knock Out'",
    type:'rose', pos:{x:0.19, y:0.18}, health:'resting', color:'#e84070', moveable:false,
    container:"in ground (Emma's Rose Garden)", gardenSection:"Emma's Rose Garden",
